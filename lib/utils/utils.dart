...
class Utils {
  ...
  static void showSnackBar(BuildContext context, String title, String message, Widget? icon) {
  ...
  static Future<bool> showWarningDialog(
      BuildContext context, String title, String msg, String button, VoidCallback onConfirm) async {
